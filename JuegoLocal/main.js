...
const config = { //Configuración general
    ...
    scene: [Charging, Preloader, MainMenu, SettingsMenu, AudioManager, PlayerSelectionMenu, MapSelectionMenu, Game, Results], //Escenas, Preloader está primero, se cargara Preloader primero
    scale: {
